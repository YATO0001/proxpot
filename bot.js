...
client.on('ready', function(){
    ...
    }, ms);535477559173840907
    console.log(` 535477559173840907 |> Name: ${client.user.username}`);
 console.log(` 535477559173840907 |> Servers: ${client.guilds.size}`);
 console.log(` 535477559173840907 |> Members: ${client.users.size}`);
 console.log(` 535477559173840907 |> Channels: ${client.channels.size}`);
 console.log(` 535477559173840907 |> Channels: ${client.channels.size}`);
 console.log(` 535477559173840907 |> Id: ${client.user.id}`);
 console.log(` 535477559173840907`);
 console.log(` 535477559173840907`);
});
